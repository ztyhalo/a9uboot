...
#define CONFIG_AUTOBOOT_STOP_STR2 	"zlg"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"pridis=video=mxcfb0:dev=lcd,4.3inch_LCD,if=RGB24\0" \
	"secdis=video=mxcfb1:dev=hdmi,1920x1080M@60,if=RGB24\0" \
	"update_sd_firmware=" \
	...
	"bootscript=echo Running bootscript from mmc ...; " \
		"source\0" \
	"loadimage=mmc read ${loadaddr} 0x800 0x5000;\0" \
	"loadfdt=mmc read ${fdt_addr} 0x5000 0x300;\0" \
